...
export type StorageHash =
  StorageHashBase<'fa95b34359cd3368434de0d34a8ee991a6d4e7fe8485939b0798ecf6f8f69df0'>;
  ...
  readonly public: {
    ...
    readonly Submission: {
      ...
      readonly status:
        ...
        | 'COMPILE_ERROR'
        | 'INTERNAL_ERROR';
      readonly passedTests: CodecTypes['pg/int4@1']['output'];
      readonly totalTests: CodecTypes['pg/int4@1']['output'];
      readonly executionTimeMs: CodecTypes['pg/int4@1']['output'];
      readonly failedTestNumber: CodecTypes['pg/int4@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly TestCase: {
  ...
  readonly public: {
    ...
    readonly Submission: {
      ...
      readonly status:
        ...
        | 'COMPILE_ERROR'
        | 'INTERNAL_ERROR';
      readonly passedTests: CodecTypes['pg/int4@1']['input'];
      readonly totalTests: CodecTypes['pg/int4@1']['input'];
      readonly executionTimeMs: CodecTypes['pg/int4@1']['input'];
      readonly failedTestNumber: CodecTypes['pg/int4@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly TestCase: {
...
export namespace Models {
  ...
  export type public_Submission = {
    ...
    status:
      ...
      | 'COMPILE_ERROR'
      | 'INTERNAL_ERROR';
    passedTests: CodecTypes['pg/int4@1']['output'];
    totalTests: CodecTypes['pg/int4@1']['output'];
    executionTimeMs: CodecTypes['pg/int4@1']['output'];
    failedTestNumber: CodecTypes['pg/int4@1']['output'] | null;
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    problem: public_Problem;
    readonly [RelationKeys]?: 'problem';
          ...
          readonly Submission: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly passedTests: { readonly column: 'passedTests' };
                readonly totalTests: { readonly column: 'totalTests' };
                readonly executionTimeMs: { readonly column: 'executionTimeMs' };
                readonly failedTestNumber: { readonly column: 'failedTestNumber' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
